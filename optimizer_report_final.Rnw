...
my.table <- c(tsea.result$optima$ess, sum(tsea.result$optima$size * scenario.weights))
...
my.table <- c(tsoa.result$optima$ess, sum(tsoa.result$optima$size * scenario.weights))
