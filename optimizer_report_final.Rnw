...
my.table$Calendar.Time.In.Years <- osea.result$optima$per.stage.sample.sizes$accrual.years

table.cap <- "Total sample size per stage for the 1SEA design and calendar times. In column names, ``A'' and ``C'' denote the treatment arm and control arm, respectively; numbers 1 and 2 indicate the corresponding subpopulation."
table.scap <- "Total sample size per stage for the 1SEA design and calendar times."
...
colnames(osea.result$optima$conj.power) <- "Reject_All"
...
my.table$Calendar.Time.In.Years <- osoa.result$optima$per.stage.sample.sizes$accrual.years

table.cap <- "Total sample size per stage for the 1SOA design and calendar times. In column names, ``A'' and ``C'' denote the treatment arm and control arm, respectively; numbers 1 and 2 indicate the corresponding subpopulation."
table.scap <- "Total sample size per stage for the 1SOA design and calendar times."
print(xtable(data.frame(Stage = 1:nrow(my.table),
                        my.table),
             caption=c(table.cap, table.scap), 
...
colnames(osoa.result$optima$conj.power) <- "Reject_All"
...
my.table$Calendar.Time.In.Years <- tsea.result$optima$per.stage.sample.sizes$accrual.years

table.cap <- "Total sample size per stage for the 2SEA design and calendar times. In column names, ``A'' and ``C'' denote the treatment arm and control arm, respectively; numbers 1 and 2 indicate the corresponding subpopulation."
table.scap <- "Total sample size per stage for the 2SEA design and calendar times."
print(xtable(data.frame(Stage = 1:nrow(my.table),
                        my.table),
             caption=c(table.cap, table.scap), 
...
colnames(tsea.result$optima$conj.power) <- "Reject_All"
...
my.table$Calendar.Time.In.Years <- tsoa.result$optima$per.stage.sample.sizes$accrual.years

table.cap <- "Total sample size per stage for the 2SOA design and calendar times. In column names, ``A'' and ``C'' denote the treatment arm and control arm, respectively; numbers 1 and 2 indicate the corresponding subpopulation."
table.scap <- "Total sample size per stage for the 2SOA design and calendar times."
print(xtable(data.frame(Stage = 1:nrow(my.table),
                        my.table),
             caption=c(table.cap, table.scap), 
