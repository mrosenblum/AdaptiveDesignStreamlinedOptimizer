...
if (DEBUG.N.SIMULATION) {
    n.simulation <- as.character(10000)
}
...
Four optimal designs are presented in this report:
\begin{itemize}
...
Below is a list of user-supplied parameters.
\begin{itemize}
    ...
    \Sexpr{MCID}
    \item Incorporate precision gain: \Sexpr{ui.incorporate.precision.gain}.
    \item Relative efficiency: \Sexpr{ui.relative.efficiency}.
    ...
    \item Distribution of outcomes assumed by the user: see \Sexpr{OUTCOME.DISTRIBUTION}.
    \item Desired Power: see Table \ref{tab:desired-power}.
...
if (ui.outcome.type == "continuous") {
    if (n.arms == 2) {
        table.cap <- "User-supplied outcome mean and standard deviation (SD) under each scenario. In column names, ``trt'' denotes the treatment arm, and ``con'' denotes the control arm; numbers 1 and 2 indicate the corresponding subpopulation."
        ...
        table.cap <- "User-supplied standard deviation (SD) under each scenario. In column names, ``S1'' and ``S2'' indicate subpopulation 1 and 2."
...
table.cap <- "User-supplied desired power. In column names, numbers 1 and 2 indicate the corresponding subpopulation."
table.scap <- "User-supplied desired power."
...
my.table$Accrual.year <- osea.result$optima$per.stage.sample.sizes$accrual.years

table.cap <- "Total sample size per stage for the 1SEA design. In column names, ``A'' and ``C'' denote the treatment arm and control arm, respectively; numbers 1 and 2 indicate the corresponding subpopulation."
table.scap <- "Total sample size per stage for the 1SEA design."
...
Table \ref{tab:1sea-ess} lists the expected sample size.

Table \ref{tab:1sea-duration} lists the expected duration.
...
my.table <- osea.result$optima$empirical.power
...
<<ESS_1SEA, results='asis'>>=

my.table <- c(osea.result$optima$ess, sum(osea.result$optima$ess * scenario.weights))

table.cap <- "Expected sample size (ESS) for the 1SEA design."
table.scap <- "Expected sample size for the 1SEA design."
print(xtable(data.frame(Scenario = c(1:n.scenarios, "average"),
                        ESS = my.table),
             caption=c(table.cap, table.scap), 
             label = "tab:1sea-ess", digits=0),
      include.rownames=FALSE, NA.string = "NA")
@

<<Duration_1SEA, results='asis'>>=

my.table <- c(osea.result$optima$duration, sum(osea.result$optima$duration * scenario.weights))

table.cap <- "Expected duation for the 1SEA design."
table.scap <- "Expected duration for the 1SEA design."
print(xtable(data.frame(Scenario = c(1:n.scenarios, "average"),
                        Duration = my.table),
             caption=c(table.cap, table.scap), 
             label = "tab:1sea-duration", digits=2),
      include.rownames=FALSE, NA.string = "NA")
@
...
my.table$Accrual.year <- osoa.result$optima$per.stage.sample.sizes$accrual.years

table.cap <- "Total sample size per stage for the 1SOA design. In column names, ``A'' and ``C'' denote the treatment arm and control arm, respectively; numbers 1 and 2 indicate the corresponding subpopulation."
table.scap <- "Total sample size per stage for the 1SOA design."
print(xtable(data.frame(Stage = 1:nrow(my.table),
                        my.table),
             caption=c(table.cap, table.scap), 
...
Table \ref{tab:1soa-ess} lists the expected sample size.

Table \ref{tab:1soa-duration} lists the expected duration.
...
my.table <- osoa.result$optima$empirical.power
colnames(my.table) <- paste("Power", colnames(my.table), sep = "_")
...
<<ESS_1SOA, results='asis'>>=

my.table <- c(osoa.result$optima$ess, sum(osoa.result$optima$ess * scenario.weights))

table.cap <- "Expected sample size (ESS) for the 1SOA design."
table.scap <- "Expected sample size for the 1SOA design."
print(xtable(data.frame(Scenario = c(1:n.scenarios, "average"),
                        ESS = my.table),
             caption=c(table.cap, table.scap), 
             label = "tab:1soa-ess", digits=0),
      include.rownames=FALSE, NA.string = "NA")
@

<<Duration_1SOA, results='asis'>>=

my.table <- c(osoa.result$optima$duration, sum(osoa.result$optima$duration * scenario.weights))

table.cap <- "Expected duation for the 1SOA design."
table.scap <- "Expected duration for the 1SOA design."
print(xtable(data.frame(Scenario = c(1:n.scenarios, "average"),
                        Duration = my.table),
             caption=c(table.cap, table.scap), 
             label = "tab:1soa-duration", digits=2),
      include.rownames=FALSE, NA.string = "NA")
@
...
my.table$Accrual.year <- tsea.result$optima$per.stage.sample.sizes$accrual.years

table.cap <- "Total sample size per stage for the 2SEA design. In column names, ``A'' and ``C'' denote the treatment arm and control arm, respectively; numbers 1 and 2 indicate the corresponding subpopulation."
table.scap <- "Total sample size per stage for the 2SEA design."
print(xtable(data.frame(Stage = 1:nrow(my.table),
                        my.table),
             caption=c(table.cap, table.scap), 
...
my.table <- tsea.result$optima$empirical.power
colnames(my.table) <- paste("Power", colnames(my.table), sep = "_")
...
my.table <- c(tsea.result$optima$ess, sum(tsea.result$optima$ess * scenario.weights))
...
my.table <- c(tsea.result$optima$duration, sum(tsea.result$optima$duration * scenario.weights))
...
my.table$Accrual.year <- tsoa.result$optima$per.stage.sample.sizes$accrual.years

table.cap <- "Total sample size per stage for the 2SOA design. In column names, ``A'' and ``C'' denote the treatment arm and control arm, respectively; numbers 1 and 2 indicate the corresponding subpopulation."
table.scap <- "Total sample size per stage for the 2SOA design."
print(xtable(data.frame(Stage = 1:nrow(my.table),
                        my.table),
             caption=c(table.cap, table.scap), 
...
my.table <- tsoa.result$optima$empirical.power
colnames(my.table) <- paste("Power", colnames(my.table), sep = "_")
...
my.table <- c(tsoa.result$optima$ess, sum(tsoa.result$optima$ess * scenario.weights))
...
my.table <- c(tsoa.result$optima$duration, sum(tsoa.result$optima$duration * scenario.weights))
