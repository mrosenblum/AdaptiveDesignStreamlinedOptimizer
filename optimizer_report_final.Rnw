...
my.table$Calendar.Time.In.Years <- osea.result$optima$per.stage.sample.sizes$outcome.years
...
my.table$Calendar.Time.In.Years <- osoa.result$optima$per.stage.sample.sizes$outcome.years
...
my.table$Calendar.Time.In.Years <- tsea.result$optima$per.stage.sample.sizes$outcome.years
...
my.table$Calendar.Time.In.Years <- tsoa.result$optima$per.stage.sample.sizes$outcome.years
